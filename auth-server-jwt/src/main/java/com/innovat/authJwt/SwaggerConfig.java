...
public class SwaggerConfig 
{
	...
	public Docket api()
	{
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.innovat.authJwt.controller"))
					.paths(regex("/.*"))
				.build()
				.apiInfo(apiInfo());
	}
	...
	private ApiInfo apiInfo() 
	{
		return new ApiInfoBuilder()
				.title("AUTH WEB SERVICE API")
                .description("Spring Boot REST API per l'autenticazione Newbidoo")
                .version("1.0.0")
